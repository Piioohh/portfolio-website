...
<header class="bgimg-2 w3-display-container w3-grayscale-min" style="padding:128px 16px" id="home">
  <div class="w3-display-right w3-text-white w3-center" style="padding:48px">
    <h1 class="w3-center"><b>Custom Kiosk<b></h1>
    <h3 class="w3-center">Manufacturing the best machine</h3>
    <p><a href="prokiosk.php" class="w3-button w3-nofill w3-border w3-border-teal w3-round-xlarge w3-large">Custom Here</a></p>
  </div> 
</header>

<!-- About Section -->
<div class="bgimg-3 w3-display-container w3-grayscale-min" style="padding:128px 16px" id="about">
  <div class="w3-display-left w3-text-black w3-center" style="padding:48px">
    <h1 class="w3-center"><b>SOTWARE SOLUTION<b></h1>
    <h3 class="w3-center">THE BEST SOLUTION</h3>
...
<div class="bgpro-2 w3-display-container w3-grayscale-min" style="padding:128px 16px">
  <div class="w3-display-right w3-text-black w3-center" style="padding:48px">
    <h1 class="w3-center"><b>SUPPORT SERVICES<b></h1>
    <h3 class="w3-center">COVERAGE FOR ENTIRE COUNTRY</h3>
    <p><a href="prosupp.php" class="w3-button w3-nofill w3-border w3-border-teal w3-round-xlarge w3-large">See More</a></p>
  </div>
</div>
