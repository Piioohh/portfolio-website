...
<div class="w3-main" style="margin-left:300px">
  ...
  <h2 class="w3-center">Support System</h2>

  <div class="w3-content w3-display-container">
    <img class="mySlides" src="images/b1.jpg" style="width:100%">
    <img class="mySlides" src="images/b2.jpg" style="width:100%">
    <img class="mySlides" src="images/b3.jpg" style="width:100%">
    <img class="mySlides" src="images/b4.jpg" style="width:100%">
    <img class="mySlides" src="images/b5.jpg" style="width:100%">
    <img class="mySlides" src="images/b6.jpg" style="width:100%">
  ...
  <div style="margin-left:40px">
    ...
    <p>-Dashboard(admin) with interesting chart and graph. (Js)</p>
    <p>-Good presentation of data.</p>
    <p>-User and Admin friendly with surver for fuctioning relate dropdown (Hide/Show Js) </p>
    <p>-File Upload and View for administrator use. (PDO & Blob)</p>
  </div>
  <hr>
