...
<div class="w3-main" style="margin-left:300px">
  ...
  <h2 class="w3-center">Ticketing Support Systems</h2>

  <div class="w3-content w3-display-container">
    <img class="mySlides" src="images/c1.jpg" style="width:100%">
    <img class="mySlides" src="images/c2.jpg" style="width:100%">
    <img class="mySlides" src="images/c3.jpg" style="width:100%">
    <img class="mySlides" src="images/c4.jpg" style="width:100%">
    <img class="mySlides" src="images/c5.jpg" style="width:100%">
    <img class="mySlides" src="images/c6.jpg" style="width:100%">
    <img class="mySlides" src="images/c7.jpg" style="width:100%">
    <img class="mySlides" src="images/c8.jpg" style="width:100%">
    <img class="mySlides" src="images/c9.jpg" style="width:100%">
    <img class="mySlides" src="images/c10.jpg" style="width:100%">
  ...
  <div style="margin-left:40px">
    <p>Features:-</p>
    <p>-Come with three panels. (Admin/FT/Customer) </p>
    <p>-Ticket provided by admin and cutomer.</p>
    <p>-Data are stored in database for future use is easier to reach than ever.</p>
  </div>
