...
<header class="pp-1 w3-display-container" style="padding:128px 48px" id="home">
  <div class="w3-display-right w3-text-black w3-center" style="padding:48px">
    <p class="w3-center w3-xxxlarge"><b>DASH TOUCH<b></p>
    <p class="w3-center w3-xxxlarge"><b>SUPPORT<b></p>
    <p class="w3-center w3-xxxlarge"><b>PROVIDER<b></p>
  </div> 
</header>

<!-- Team Section -->
<div class="pp-5 w3-container" style="padding:128px 80px" id="team">
  <h1 class="w3-center"><b>OUR SUPPORT:</b></h1>
  <div class="w3-row-padding w3-center" style="margin-top:64px">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="images/pp5.png" alt="John" style="width:100%">
        <div class="w3-container">
          <h3>Efficient Work</h3>
          <h4><b>Completing task given effeciently and completely</b></h4>
        </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="images/pp6.png" alt="Jane" style="width:100%">
        <div class="w3-container">
          <h3>24/7</h3>
          <h4><b>Fast responding support service for 24/7 hour</b></h4>
        </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="images/pp7.png" alt="Mike" style="width:100%">
        <div class="w3-container">
          <h3>Solving Skills</h3>
          <h4><b>Troubleshoot and solve technical issue onsite</b></h4>
        </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="images/pp8.png" alt="Dan" style="width:100%">
        <div class="w3-container">
          <h3>Max Review</h3>
          <h4><b>Recieve and send goods to all nationwide</b></4>
        </div>
      </div>
    </div>
  </div>
...
<div class="pp-3 w3-display-container" style="padding:128px 16px">
  <div class="w3-display-left w3-text-black w3-center" style="padding:48px">
    <h1 class="w3-center"><b>INSTANT SERVICES<b></h1>
    <h3 class="w3-center">24/7 AND FAST SERVICES</h3>
  </div>
</div>

<!-- About Section -->
<div class="pp-4 w3-display-container" style="padding:128px 16px" id="about">
  <div class="w3-display-right w3-text-black w3-center" style="padding:48px">
    <h1 class="w3-center"><b>LOGISTIC WITH TRUST<b></h1>
    <h3 class="w3-center">LOGISTICALLY PROVEN SUPPORT SERVICES</h3>
  </div>
</div>
...
<div class="w3-row" >
  ...
  <div class="w3-half container"  style="padding: 0 0">
    <img src="images/pro1.jpg" width="100%">
    <div class="bottom-right w3-text-black">
    <p><a href="prokiosk.php" class="w3-button w3-nofill w3-border w3-border-teal w3-round-xlarge w3-large">Future Begin Here</a></p>
    </div>
  </div>
</div>
