...
<div class="w3-main" style="margin-left:300px">
  ...
  <h2 class="w3-center">React JS simple project (UI only)</h2>

  <div class="w3-content w3-display-container">
    <img class="mySlides" src="images/react1.png" style="width:100%">
    <img class="mySlides" src="images/react2.png" style="width:100%">
    <img class="mySlides" src="images/react3.png" style="width:100%">
    <img class="mySlides" src="images/react4.png" style="width:100%">
    <img class="mySlides" src="images/react5.png" style="width:100%">
  ...
  <div style="margin-left:40px">
    <p>Features:-</p>
    <p>-A simple UI project using React JS</p>
  </div>
  <hr>
