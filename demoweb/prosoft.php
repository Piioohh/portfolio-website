...
<div class="w3-row w3-display-container w3-khaki w3-grayscale-min" style="padding:128px 160px">
    <header>
	<h2 class="w3-center">Software Services</a></h2>
	</header>
    <br>
    <br>
    <div class="w3-third w3-container w3-center">
      
            <img class="w3-img w3-hover-opacity" src="images/s1.png" onclick="onClick(this)" style="width:80%">
            <h2>HAMPSHIRE KIOSK</h2>
            <br>
    ...
    <div class="w3-third w3-container w3-center">
            ...
            <img class="w3-img w3-hover-opacity" src="images/s2.png" onclick="onClick(this)" style="width:80%">
            <h2>KLM KIOSK</h2>
            <br>
    ...
    <div class="w3-third w3-container w3-center">
            ...
            <img class="w3-img w3-hover-opacity" src="images/s3.png" onclick="onClick(this)" style="width:80%">
            <h2>TM KIOSK</h2>
            <br>
    ...
    <div class="w3-third w3-container w3-center">
            ...
            <img class="w3-img w3-hover-opacity" src="images/s4.png" onclick="onClick(this)" style="width:80%">
            <h2>KLM KIOSK</h2>
    ...
    <div class="w3-third w3-container w3-center">
            ...
            <img class="w3-img w3-hover-opacity" src="images/s5.png" onclick="onClick(this)" style="width:80%">
            <h2>MAXIS KIOSK</h2>
    ...
    <div class="w3-third w3-container w3-center">
            ...
            <img class="w3-img w3-hover-opacity" src="images/s6.png" onclick="onClick(this)" style="width:80%">
            <h2>MAIN PLACE KIOSK</h2>
